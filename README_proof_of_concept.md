...
- Create two local databases (on your vagrant image) named exactly (exactly is only for this proof of concept) as below:
  - `TestExamExerciseType2`
  - `TestExamExerciseType2_test`
- Create a REMOTE database on your Droplet named exacly like this: `TestExamExerciseType2`
...
`export CONNECTION_STR="jdbc:mysql://localhost:3306/TestExamExerciseType2"
`
