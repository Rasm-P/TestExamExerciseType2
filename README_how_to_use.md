...
- **Important:** Locate the file **.travis.yml** in the root, and change the script `CREATE DATABASE TestExamExerciseType2_test;`to use the SAME name as your local test-database (xxx_test) above
